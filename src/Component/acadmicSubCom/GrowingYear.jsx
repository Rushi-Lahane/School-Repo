...
const GrowingYear = () => {
    return (
        <div className='text-center'>
            <h2 className='text-blue-900 text-xl font-bold' >THE MIDDLE SCHOOL</h2>
            <h2 className='text-blue-900 text-xl font-bold'>V TO VIII</h2>

            <p className='text-justify text-gray-500 text-lg mt-4'>
